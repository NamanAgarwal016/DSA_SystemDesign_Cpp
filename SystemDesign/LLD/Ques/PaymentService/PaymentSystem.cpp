/*
Payment Gateway System Desgin

Reqs:
- Should support multiple providers (Paytm, Razorpay, etc...)
- Add new gateways easily in fututre
- there should be a standard payment flow, with required validations
- Have error & retry mechanism
- Plug n Play model


Very Good use of proxy & template desgin methods
...
int main() {
    ...
    // To generate random values each time code is executed
